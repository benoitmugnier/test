(function (global, factory) {
    ...
    var MarkerManager = /** @class */ (function () {
        ...
        MarkerManager = __decorate$4([
            core.Injectable(),
            __metadata$3("design:paramtypes", [GoogleMapsAPIWrapper, core.NgZone])
        ], MarkerManager);
    ...
    var InfoWindowManager = /** @class */ (function () {
        ...
        InfoWindowManager = __decorate$5([
            core.Injectable(),
            __metadata$4("design:paramtypes", [GoogleMapsAPIWrapper, core.NgZone,
                MarkerManager])
        ], InfoWindowManager);
    ...
    var PolygonManager = /** @class */ (function () {
        ...
        PolygonManager = __decorate$6([
            core.Injectable(),
            __metadata$5("design:paramtypes", [GoogleMapsAPIWrapper, core.NgZone])
        ], PolygonManager);
    ...
    var PolylineManager = /** @class */ (function () {
        ...
        PolylineManager = PolylineManager_1 = __decorate$7([
            core.Injectable(),
            __metadata$6("design:paramtypes", [GoogleMapsAPIWrapper, core.NgZone])
        ], PolylineManager);
    ...
    var KmlLayerManager = /** @class */ (function () {
        ...
        KmlLayerManager = __decorate$8([
            core.Injectable(),
            __metadata$7("design:paramtypes", [GoogleMapsAPIWrapper, core.NgZone])
        ], KmlLayerManager);
    ...
    var DataLayerManager = /** @class */ (function () {
        ...
        DataLayerManager = __decorate$9([
            core.Injectable(),
            __metadata$8("design:paramtypes", [GoogleMapsAPIWrapper, core.NgZone])
        ], DataLayerManager);
    ...
    var FitBoundsService = /** @class */ (function () {
        ...
        FitBoundsService = __decorate$10([
            core.Injectable(),
            __metadata$9("design:paramtypes", [MapsAPILoader])
        ], FitBoundsService);
    ...
    var AgmMap = /** @class */ (function () {
        ...
        __decorate$11([
            core.Output(),
            __metadata$10("design:type", core.EventEmitter)
        ...
        AgmMap = AgmMap_1 = __decorate$11([
            ...
            __metadata$10("design:paramtypes", [core.ElementRef, GoogleMapsAPIWrapper, FitBoundsService])
        ], AgmMap);
        return AgmMap;
    }());
    ...
    var AgmCircle = /** @class */ (function () {
        ...
        AgmCircle = AgmCircle_1 = __decorate$12([
            core.Directive({
                selector: 'agm-circle'
            }),
            __metadata$11("design:paramtypes", [CircleManager])
        ], AgmCircle);
        return AgmCircle;
    }());
    ...
    var AgmRectangle = /** @class */ (function () {
        ...
        AgmRectangle = AgmRectangle_1 = __decorate$13([
            core.Directive({
                selector: 'agm-rectangle'
            }),
            __metadata$12("design:paramtypes", [RectangleManager])
        ], AgmRectangle);
        return AgmRectangle;
    }());
    ...
    var AgmInfoWindow = /** @class */ (function () {
        ...
        __decorate$14([
            core.Output(),
            __metadata$13("design:type", core.EventEmitter)
        ], AgmInfoWindow.prototype, "infoWindowClose", void 0);
        AgmInfoWindow = AgmInfoWindow_1 = __decorate$14([
            core.Component({
                selector: 'agm-info-window',
                template: "<div class='agm-info-window-content'>\n      <ng-content></ng-content>\n    </div>\n  "
            }),
            __metadata$13("design:paramtypes", [InfoWindowManager, core.ElementRef])
        ], AgmInfoWindow);
    ...
    var AgmKmlLayer = /** @class */ (function () {
        ...
        __decorate$15([
            core.Output(),
            __metadata$14("design:type", core.EventEmitter)
        ...
        AgmKmlLayer = AgmKmlLayer_1 = __decorate$15([
            core.Directive({
                selector: 'agm-kml-layer'
            }),
            __metadata$14("design:paramtypes", [KmlLayerManager])
        ], AgmKmlLayer);
        return AgmKmlLayer;
    }());
    ...
    var AgmDataLayer = /** @class */ (function () {
        ...
        __decorate$16([
            core.Output(),
            __metadata$15("design:type", core.EventEmitter)
        ...
        AgmDataLayer = AgmDataLayer_1 = __decorate$16([
            core.Directive({
                selector: 'agm-data-layer'
            }),
            __metadata$15("design:paramtypes", [DataLayerManager])
        ], AgmDataLayer);
        return AgmDataLayer;
    }());
    ...
    var AgmMarker = /** @class */ (function () {
        ...
        __decorate$17([
            core.Output(),
            __metadata$16("design:type", core.EventEmitter)
        ...
        __decorate$17([
            ...
            __metadata$16("design:type", core.QueryList)
        ], AgmMarker.prototype, "infoWindow", void 0);
        AgmMarker = AgmMarker_1 = __decorate$17([
            core.Directive({
                selector: 'agm-marker',
                providers: [
            ...
            __metadata$16("design:paramtypes", [MarkerManager])
        ], AgmMarker);
        return AgmMarker;
    }());
    ...
    var AgmPolygon = /** @class */ (function () {
        ...
        __decorate$18([
            core.Input(),
            __metadata$17("design:type", Array)
        ...
        __decorate$18([
            core.Output(),
            __metadata$17("design:type", core.EventEmitter)
        ...
        AgmPolygon = AgmPolygon_1 = __decorate$18([
            core.Directive({
                selector: 'agm-polygon'
            }),
            __metadata$17("design:paramtypes", [PolygonManager])
        ], AgmPolygon);
        return AgmPolygon;
    }());
    ...
    var AgmPolylinePoint = /** @class */ (function () {
        ...
        AgmPolylinePoint = __decorate$19([
    ...
    var AgmPolyline = /** @class */ (function () {
        ...
        __decorate$20([
            core.Output(),
            __metadata$19("design:type", core.EventEmitter)
        ...
        __decorate$20([
            ...
            __metadata$19("design:type", core.QueryList)
        ], AgmPolyline.prototype, "points", void 0);
        AgmPolyline = AgmPolyline_1 = __decorate$20([
            core.Directive({
                selector: 'agm-polyline'
            }),
            __metadata$19("design:paramtypes", [PolylineManager])
        ], AgmPolyline);
        return AgmPolyline;
    }());
    ...
    var AgmFitBounds = /** @class */ (function () {
        ...
        AgmFitBounds = __decorate$21([
            core.Directive({
                selector: '[agmFitBounds]'
            }),
            __param(0, core.Self()),
            __metadata$20("design:paramtypes", [FitBoundsAccessor,
                FitBoundsService])
        ], AgmFitBounds);
        return AgmFitBounds;
    }());
    ...
    var LazyMapsAPILoader = /** @class */ (function (_super) {
        ...
        LazyMapsAPILoader = __decorate$22([
            core.Injectable(),
            __param$1(0, core.Optional()), __param$1(0, core.Inject(LAZY_MAPS_API_CONFIG)),
            __metadata$21("design:paramtypes", [Object, WindowRef, DocumentRef])
        ], LazyMapsAPILoader);
    ...
    var AgmCoreModule = /** @class */ (function () {
        ...
        var AgmCoreModule_1;
        AgmCoreModule = AgmCoreModule_1 = __decorate$23([
